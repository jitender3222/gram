<html>
	<head>
		...
		<meta name="keywords" content="gram, swaraj, gramswaraj, baldhan kalan, baldhan, gram swaraj sangathan, baldhankalan, gramswarajsangathan, gram swaraj, info@gramswarajsangathan.com, gramswarajsangathan.com, www.gramswarajsangathan.com, www.gramswaraj.com, gramswaraj.com">
		<meta name="description" content="Gram Swaraj Sangathan is social group of young people of village Baldhan Kalan Distt.- Rewari(haryana).It works for people to highlight their their problems to administration and also runs lot of social activity and cultural activities.">
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
			  ...
			  <li><a href="contactus.php"><font class="mytextcolor menutext">हमसे संपर्क करे</font></a></li>
            </ul>
		</div>
		</div>
		</div>
    ...
    <!-- Jssor Slider End -->
		...
		<div class=" navbar-header navbar navbar-default" style="background-color:#eee;width:1140px;">
			<div class="row">
				...
				<div class="col-md-5">
				<font class="font4">Gram Swaraj Sangathan founded   on October 6th, 2013.</font>
				
				
				</div>
				
				
				<div  class="col-md-4" style="width:300px;margin:0 auto 0 auto;">
					<div  class="fb-like-box " data-href="https://www.facebook.com/GramSwarajSangathan" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="true"></div>
					</div>
					</div>
					</div>
